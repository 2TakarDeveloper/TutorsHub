<html>
	...
	<div class="pp">  <h1>tutorsHUB</h1> </div>
		...
		<td></td>
			<td align="center">
			<a href="http://localhost/project/mywork/register.php">not registered yet</a>
			</td>
		</tr>
	...
	<br/>
		...
		<div align="center">
			<button class="button" type="submit" formaction="http://localhost/project/mywork/search.php">Search</button>
		</div>
		<br/>
